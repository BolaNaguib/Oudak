      ...
      <div class="uk-grid-match" uk-grid>
        ...
        <div class="uk-width-1-2">
          <div class="uk-card uk-card-default uk-text-center uk-padding" uk-scrollspy="cls: uk-animation-slide-bottom;">
            ...
            <div class="uk-width-1-1">
              <p class="uk-text-left">Just Some Simple Text Just Some Simple Text Just Some Simple Text Just Some Simple Text Just Some Simple Text Just Some Simple Text Just Some Simple Text Just Some Simple Text Just Some Simple Text Just Some
                Simple Text</p>
